...
class TraceField(object):
    ...
    def _Trace(self, x0, y0, z0, IntModel="jrm33", ExtModel="Con2020", **kwargs):
        ...
        self.Verbose = np.bool_(cfg["Verbose"])
    ...
    def PlotPigtail(
        self, Proj="normal", ShowLabels=True, Time=None, Date=None, ut=None, Hemisphere="both", colatlim=None, fig=None, maps=[1, 1, 0, 0], **kwargs
    ):
        """
